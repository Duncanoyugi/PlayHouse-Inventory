...
export function ResourceManager({ title, description, resourceName, fields, queryKey, list, create, update, remove }: ResourceManagerProps) {
  ...
  const openCreate = () => { setDraft({ status: 'ACTIVE' }); setEditing(null); setIsCreating(true) }
  ...
  return <div className="space-y-6">
    <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
      ...
      <Button onClick={openCreate}><Plus className="mr-2 h-4 w-4" /> Add {resourceName}</Button>
    </div>
